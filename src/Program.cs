...
using LClaproth.MyFinancialTracker.Identity.EntityFrameworkCore;
...
builder.Services.AddScoped<RegistrationService<IdentityUser>>();
builder.Services.AddScoped<AuthenticationService<IdentityUser>>();
